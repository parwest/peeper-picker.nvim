...
function M.open(state, lookup_id)
  ...
  bind(list_buf, "n", "j", function() view.move_cursor(state, 1) end)
  bind(list_buf, "n", "<Down>", function() view.move_cursor(state, 1) end)
  bind(list_buf, "n", "k", function() view.move_cursor(state, -1) end)
  bind(list_buf, "n", "<Up>", function() view.move_cursor(state, -1) end)
